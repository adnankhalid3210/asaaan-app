...
export class AppService {
    ...
    public getBrands(){
        return [  
            ...
            { name: 'Electrician', image: 'https://cdn0.iconfinder.com/data/icons/worker-3/229/worker-man-tool-equipment-aaa008-512.png' },
            { name: 'Plumber', image: 'https://static.thenounproject.com/png/636557-200.png' },
            { name: 'Carpenter', image: 'https://static.thenounproject.com/png/1124401-200.png' },
            { name: 'Mechanic', image: 'https://static.thenounproject.com/png/636558-200.png' },
            { name: 'Maids', image: 'https://image.flaticon.com/icons/svg/66/66241.svg' },
            { name: 'Tutor', image: 'https://static.thenounproject.com/png/510086-200.png' },
            { name: 'Beautician', image: 'https://cdn3.iconfinder.com/data/icons/beauty-salon/234/beauty-services-003-512.png' },
            { name: 'A/C Repair', image: 'https://i2.wp.com/www.advancedheatingandair.com/wp-content/uploads/2015/10/icon1.png' },
